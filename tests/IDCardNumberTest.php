...
use Chendujin\IdCardNumber\IdCardNumber;
use PHPUnit\Framework\TestCase;

class IDCardNumberTest extends TestCase
{
    public function identifyNumberProvider(): array
    {
        return [
    ...
    public function invalidIdentifyNumberProvider(): array
    {
        return [
            ['fjadlfjdaklfjdjla'],
            ['36232919980110555X'],
    ...
    {
        $IDCard = new IdCardNumber($identifyNumber);
